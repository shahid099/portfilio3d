  ...
  return (
    <div className="mt-12 bg-black-100 rounded-[20px]">
      ...
      <motion.div variants={textVariant()}>
        ...
        >
          © 2022 - Present M Shahid. All Rights Reserved.
        </div>
        <div className="flex justify-end mt-[-15px] mr-12 pb-5">
          <a
            href="https://www.linkedin.com/in/muhammad-shahid-865107212/"
            target="_blank"
          ...
          <a
            href="mailto:shahidmuhammadshahid099@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            className="icon-link rounded-full p-2 hover:bg-secondary transition
          duration-200 ease-linear"
          ...
          <a
            href="https://github.com/shahid099"
            target="_blank"
            rel="noopener noreferrer"
            className="icon-link rounded-full p-2 hover:bg-secondary transition
          duration-200 ease-linear"
